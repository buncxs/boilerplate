    ...
    <div class="user-container d-flex">
        <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true"
            ...
            <img class="profile" alt="profile"
                src="{{ isset(Auth::user()->profile_photo_path) ? Storage::url(Auth::user()->profile_photo_path) : 'no_image.webp' }}" />
            <div class="name">{{ Auth::user()->name }}</div>
        </a>
        <div class="dropdown-menu dropdown-menu-end user-menu wide">
            <div class="row mb-1 ms-0 me-0">
                <div class="col-12 p-1 mb-2 pt-2">
                    <div class="text-medium text-primary">ACCOUNT</div>
                </div>
            </div>
            <div class="row mb-1 ms-0 me-0">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="{{ route('profile.edit') }}">
                                <i data-acorn-icon="gear" class="me-2" data-acorn-size="21"></i>
                        ...
                        <li>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <a href="{{ route('logout') }}"
                                    ...
                                    <i data-acorn-icon="logout" class="me-2" data-acorn-size="21"></i>
